...
class TorneioApp:
    ...
    def gerar_fase_ui(self):
        ...
        # Título da Fase Menor
        titulo = f"FASE {self.fase_n}" + (" (REPESCAGEM)" if self.em_repescagem else "")
        tk.Label(self.root, text=titulo, fg=self.accent, bg=self.bg,
        ...
        self.btn_next = tk.Button(
            ...
            bg="#28a745",
            fg="white",
            font=("Arial", 12, "bold"), # Fonte reduzida
        ...
        tk.Label(nav_frame,
                text=f"Página {self.pagina_atual + 1} de {total_paginas}",
        ...
        for a, b in duelos_pagina:
            ...
            tk.Label(
                f_duelo, text="VS", fg=self.accent, bg=self.card,
                font=("Arial", 10, "bold")
